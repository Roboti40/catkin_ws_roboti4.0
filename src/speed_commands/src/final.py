...
def move_to(x_target, y_target):
    ...
    while True:
        ...
        if encoder_values:
            ...
            current_position = update_position(current_position, encoder_positions, prev_encoder_positions, dt)
            ...
            # Calculate error
            error = np.array([x_target, y_target,theta_target]) - current_position[:]
            ...
            omega_d = control_signal[2]  # Assuming no rotation for simplicity
